  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground",
        subtle:
          "hover:bg-sidebar-accent-subtle hover:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent-subtle data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
...
const SidebarMenuButton = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button"> & SidebarMenuButtonVariants
...
>(({ className, ...props }, ref) => {
  return (
    <button
      ...
      className={cn(
        "absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1 hover:bg-sidebar-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-2",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <span
      ...
      className={cn(
        "ml-auto rounded-md bg-sidebar-border px-2 py-0.5 text-[0.6rem] font-semibold leading-5",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-sub relative", className)}
    {...props}
  />
))
