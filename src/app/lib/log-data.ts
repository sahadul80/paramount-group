import { getAccessTokenFromServiceAccount, getOrCreateFolder } from './google-auth';
import axios from 'axios';

const LOG_FILE_NAME = 'access-log.json';
const GOOGLE_DRIVE_UPLOAD_URL = 'https://www.googleapis.com/upload/drive/v3/files';
const GOOGLE_DRIVE_API_URL = 'https://www.googleapis.com/drive/v3/files';

const accessToken = await getAccessTokenFromServiceAccount();
const userDataFolderId = await getOrCreateFolder(accessToken, "visitor-log");
...
export async function writeLogFile(logs: LogEntry[]): Promise<void> {
    try {
